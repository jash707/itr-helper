# 🧾 ITR-2 Helper — Copy-Ready Portal Field Guide Generator (FY 2025-26 / AY 2026-27)

An automated client-side data processing engine built with **Vite, React, TypeScript, and Material UI** for salaried individuals filing Indian Income Tax Return 2 (**ITR-2**) for **Financial Year 2025-26 (Assessment Year 2026-27)**.
...
- **📋 7 Copy-Ready ITR-2 Portal Tabs**:
  ...
  2. **Schedule S (Salary)**: Sections 17(1), 17(2), 17(3), Section 10 exempt allowances, Section 16 deductions (Standard Deduction ₹75k, Professional Tax).
  3. **Schedule HP (House Property)**: Self-occupied home loan interest u/s 24b (up to ₹2 Lakhs) and let-out property rental income.
  4. **Schedule CG (Capital Gains)**: Short-Term (111A) @ 20%, Long-Term (112A) @ 12.5% above ₹1.25L exemption, and **Item E 5-Quarterly Accrual Breakdown**.
...
- **🔄 Schedule BFLA & Schedule CFL (Loss Set-Off Engine)**:
  ...
  - Unabsorbed losses to carry forward to AY 2027-28 are tracked automatically.
  - **Option 1 Auto-Extraction**: Upload your previous year's filed return `.json` (`ITR2_2025.json`) to automatically extract brought-forward losses.

- **📑 Complete Filing Guidance Page**:
  - Interactive step-by-step portal manual, document download guide (Groww, NetBanking, HR portals), FY 2025-26 tax rates, and AIS / Form 26AS verification tips.
...
3. **Copy Values to Portal**:
   - Log in to `incometax.gov.in` → e-File → Income Tax Return → AY 2026-27 → ITR-2.
...
## 📜 Tax Rates Summary for FY 2025-26 (AY 2026-27)

- **Short-Term Capital Gains (111A)**: Taxed @ **20%**
- **Long-Term Capital Gains (112A)**: Taxed @ **12.5%** on gains exceeding **₹1,25,000** exemption.
